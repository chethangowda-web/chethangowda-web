...
class Chethan {
  ...
  langs     = ["Java", "Python", "JavaScript", "React.js", "Next.js", "TypeScript"];
  focus     = "Frontend Development · UI Engineering";
  learning  = "Advanced React patterns, animation, and system design";
  mission   = "Build interfaces people actually enjoy using.";
  belief    = "Pixel-perfect isn't a bonus — it's the baseline.";

  introduce() {
    console.log("Let's build something people love to click through. 🚀");
  }
}
```

- 🔭 Currently focused on **Frontend Development** — React, Next.js, and UI engineering
- 🌱 Leveling up **animation, design systems, and component architecture**
- 🏆 1st place, Xpheria 2026 (UI/UX) · 3rd place, Protonex Hackathon (CareAI)
- 💬 Ask me about: **React, Next.js, or turning Figma into real code**
- ⚡ Fun fact: I obsess over 2px of padding until it feels right
...
<img src="https://skillicons.dev/icons?i=java,python,js,ts,react,nextjs,tailwind,html,css,git,figma,vercel&theme=dark" />
...
![Snake animation](https://github.com/chethangowda-web/chethangowda-web/blob/output/github-contribution-grid-snake-dark.svg)
...
```
  Q1 2026  ████████████████████  100%  ✅  SentinelFlow AI — advanced to Round 2, HiDevs x Mastra
  Q2 2026  ████████████████░░░░   80%  🔄  Shifted focus to Frontend Development — React & Next.js
  Q3 2026  ██████░░░░░░░░░░░░░░   30%  🔲  Ship a polished frontend portfolio + component library
...
<img align="right" width="250" src="https://media.giphy.com/media/xUOxf48UtjF1kw6h3W/giphy.gif" />

Most people write code that works. I want code that also *feels* right to use.

What chasing polish hardwires into me:

| Habit | Developer Superpower |
|-------|----------------------|
| 🎨 UI-First Thinking | Interfaces that convert, not just render |
| 🧩 Component Architecture | Reusable, scalable frontend systems |
| 🐛 Cross-Browser Debugging | Nothing breaks quietly on my watch |
| 🌱 Shipping Publicly | Real feedback beats guesswork |

> *"Good frontend is invisible — you only notice when it's bad."*
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-Chethan%20Gowda-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/chethan-gowda-s-n-abb165329/)
[![GitHub](https://img.shields.io/badge/GitHub-chethangowda--web-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/chethangowda-web)

<br/><br/>

```
╔══════════════════════════════════════════════════════════════╗
║   Frontend is chapter two. The best interfaces are ahead. 🌟 ║
║      Always down to talk React, design systems, or code.    ║
╚══════════════════════════════════════════════════════════════╝
```
